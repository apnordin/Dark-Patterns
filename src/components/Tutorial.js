...
export default function Tutorial ( {setGoToStart, setGoToTutorial } ) {
    return (
        <div className="col-12 text-center">
            ...
            <div className="row">
                ...
                <div className="col-12 text-center">
                    <button onClick={() => {setGoToStart(false); setGoToTutorial(false);}} type="button" className="btn btn-grey mr-1 mt-3">Go Back</button>
                    <button onClick={() => {setGoToStart(true); setGoToTutorial(false);}} type="button" className="btn btn-main ml-1 mt-3">Start!</button>
                </div>
            </div>
        </div>
    )
